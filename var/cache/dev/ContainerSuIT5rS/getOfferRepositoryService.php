 ...
 */
class getOfferRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OfferRepository.php';

        return $container->privates['App\\Repository\\OfferRepository'] = new \App\Repository\OfferRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
