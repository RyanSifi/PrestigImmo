 ...
 */
class getRealPropertyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RealPropertyRepository' shared autowired service.
     *
     * @return \App\Repository\RealPropertyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RealPropertyRepository.php';

        return $container->privates['App\\Repository\\RealPropertyRepository'] = new \App\Repository\RealPropertyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
