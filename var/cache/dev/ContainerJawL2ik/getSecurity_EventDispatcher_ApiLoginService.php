 ...
 */
class getSecurity_EventDispatcher_ApiLoginService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->privates['security.event_dispatcher.api_login'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'security.listener.user_checker.api_login', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] function () use ($container) {
            return ($container->privates['security.listener.user_checker.api_login'] ?? $container->load('getSecurity_Listener_UserChecker_ApiLoginService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => #[\Closure(name: 'security.listener.user_checker.api_login', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] function () use ($container) {
            return ($container->privates['security.listener.user_checker.api_login'] ?? $container->load('getSecurity_Listener_UserChecker_ApiLoginService'));
